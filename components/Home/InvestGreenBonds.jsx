    ...
    <div className='w-full flex flex-row-reverse max-sm:flex-col justify-between items-center gap-x-[50px] lg:gap-x-[120px] gap-y-[20px]'>
      ...
      <div className='flex flex-col gap-y-[10px]'>
        ...
        <Typography.P className="!text-[#FFFFFF] font-haas font-normal text-[16px] mt-[10px]">
          Ancestro Green Bonds are backed by real projects across Latin America:
        </Typography.P>
        <List list={["Solar → Long-term PPAs with creditworthy offtakers.", "Wind → Large-scale contracts with proven operators.", "Battery-as-a-Service → Backup power subscriptions.", "EV Charging → Building the first continent-wide fast-charge network."]} />
        ...
        <div className='flex flex-col gap-y-[10px]'>
          <Points data={["Assets are owned + maintained by Ancestro.", "Investors stay 100% passive.", "Monthly cash flow from projects → your returns."]} />
        </div>
      </div>
    </div>
  )
